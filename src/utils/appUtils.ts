...
export type LocalizedContent = string | { es?: string; en?: string };

// Tipo para item con ID único
export interface ItemWithUniqueId extends BaseItem {
  globalId: string;
 ...
 */
export const getDefaultTitle = (lang: string): string => {
 ...
 */
export const ensureUniqueId = (item: any, fallbackIndex: number = 0): ItemWithUniqueId => {
  return {
    ...item,
 ...
 */
export const processItemsWithUniqueIds = (items: any[]): ItemWithUniqueId[] => {
 ...
 */
export const getLocalizedContent = (content: LocalizedContent, lang: string = 'es'): string => {
  if (typeof content === 'string') {
    return content;
  }
  
  if (typeof content === 'object' && content !== null) {
    return (content as any)[lang] || content.es || content.en || '';
  }
 ...
 */
export const getLocalizedTitle = (item: any, lang: string = 'es'): string => {
 ...
 */
export const getLocalizedDescription = (item: any, lang: string = 'es'): string => {

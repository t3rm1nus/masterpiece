...
type NavigationContext = 'detail' | 'coffee' | 'howToDownload' | 'home';
 ...
 */
export default function useBackNavigation(): UseBackNavigationReturn {
  ...
  const getContext = (): NavigationContext => {

...
export function useMenuItems(handleSplashOpen, onOverlayNavigate) {
  ...
  const handleNewRecommendations = useCallback(() => {
    ...
    if (onOverlayNavigate) {
      ...
      onOverlayNavigate('/');
      // Hacer scroll al top después de un pequeño delay para asegurar que la navegación se complete
      setTimeout(() => {
        window.scrollTo({ top: 0, behavior: 'smooth' });
      }, 100);
    }
  }, [resetAllFilters, generateNewRecommendations, lang, onOverlayNavigate]);

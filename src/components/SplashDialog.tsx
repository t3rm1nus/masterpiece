...
interface SplashDialogProps {
  ...
  DialogContentProps?: Record<string, any>;
...
const SplashDialog: React.FC<SplashDialogProps> = ({
  ...
  function addIdToImg(element: ReactNode): ReactNode {
    ...
    const propsAny = element.props as any;
    if ((element.type as any) === 'img') {
    ...
    if (propsAny && propsAny.children) {
      const children = React.Children.map(propsAny.children as ReactNode, addIdToImg);

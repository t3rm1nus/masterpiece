...
export const MobileCategorySpecificContent: React.FC<CategorySpecificContentProps> = ({ selectedItem, lang, t, getTranslation }) => {
  // Documentales
...
export const DesktopCategorySpecificContent: React.FC<CategorySpecificContentProps> = ({ selectedItem, lang, t, getTranslation }) => {
  const infoRows = [];
  if (selectedItem.category === 'documentales') {
